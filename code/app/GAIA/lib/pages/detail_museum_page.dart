        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text("Voici un aperçu de ce que vous pourrez découvrir :", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: 16),
              ...
              FutureBuilder<List<Artwork>>(
                ...
                builder: (context, snapshot) {
                  ...
                  final displayedArtworks = artworks.take(6).toList(); // Prend les 6 premiers
